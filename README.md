...
3. Add this repository URL: `https://github.com/wanball/air-quality-card` and select **Lovelace** as the Type.
...
3. วางลิงก์ URL: `https://github.com/wanball/air-quality-card` และเลือกประเภท (Type) เป็น **Lovelace** (หรือ **Dashboard**)
